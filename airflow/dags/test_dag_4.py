...
with DAG("test_4", default_args=default_args, schedule_interval=None,
    ...
    ecs_task = ECSOperator(
        task_id="ecs_task",
        cluster="ecs-fargate-test-4",
        task_definition="ecs-fargate-test-4",
        launch_type="FARGATE",
        overrides={
            "containerOverrides": [
                {
        ...
        awslogs_stream_prefix="tasks/ecs-fargate-test-4",
